    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="panel-accent max-h-[80vh] w-full max-w-lg overflow-hidden rounded-2xl">
        <div className="flex items-center justify-between border-b border-black/8 px-5 py-4">
          <h2 className="font-semibold text-brand-black">Export summary</h2>
          <button type="button" onClick={onClose} className="text-muted hover:text-brand-black">
            ✕
          </button>
        </div>

        <div className="flex gap-2 border-b border-black/8 px-5 py-3">
          <button
            type="button"
        ...
        <pre className="max-h-96 overflow-auto whitespace-pre-wrap px-5 py-4 text-sm text-brand-black">
          {preview}
        </pre>

        <div className="flex flex-wrap justify-end gap-2 border-t border-black/8 px-5 py-4">
